...
const Navbar = () => {
  ...
  return (
    <>
      <div className="sticky text-3xl font-thin">
        <div className="flex justify-between  items-center select-none absolute w-full py-8 h-32">
          <Link to="/" className="hover:text-neutral-200">
            <Logo />
          </Link>
          <Menu
